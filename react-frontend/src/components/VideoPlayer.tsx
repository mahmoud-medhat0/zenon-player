...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videoId, token, onClose, isEmbed = false, primaryColor, streamUrl }) => {
  ...
  useEffect(() => {
    ...
    const resolvedStreamUrl = streamUrl ?? `${apiBase}/videos/${videoId}/stream/playlist.m3u8`;
